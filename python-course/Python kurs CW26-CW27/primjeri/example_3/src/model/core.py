...
class Module(NameSpace):
    ...
    def add_call(self, function_name, result, *args):
        ...
        i = 0        
        #TODO:
        # Ako se kao vrednost parametra navede promenljiva, proveriti da li je promenljiva deklarisana!
        # Proveriti da li se parametar i prosledjena vrednost slazu po tipu i nacinu prenosa vrednosti!                 
